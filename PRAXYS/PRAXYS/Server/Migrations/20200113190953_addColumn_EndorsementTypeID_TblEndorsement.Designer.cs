...
namespace PRAXYS.Server.Migrations
{
    ...
    [Migration("20200113190953_addColumn_EndorsementTypeID_TblEndorsement")]
    partial class addColumn_EndorsementTypeID_TblEndorsement
    {
            ...
            modelBuilder.Entity("PRAXYS.Shared.Entities.Bond", b =>
                {
                    ...
                    b.HasOne("PRAXYS.Shared.Entities.Clients", "Clients")
                        .WithMany()
